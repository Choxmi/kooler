	...
	protected void onCreate(Bundle icicle){
		...
		bSave.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				try{
				Toast.makeText(ShippingInformationActivity.this, "Place Loading", Toast.LENGTH_LONG);
				Log.e("Place", "Load data to place");
				Place place = new Place();
					Log.e("Place", "Setting ID");
				place.setId("1");
				...
				place.setLastname(etLastName.getText().toString().trim());
					...
					sl.setId(sCountries.getSelectedItem().toString());
				place.setCountry(sl);
					Zone a = new Zone();
					a.setName("SL");
				place.setZone(a);
				...
				entity.setData(place);
					...
					Toast.makeText(ShippingInformationActivity.this, "Place ID is "+place.getId(), Toast.LENGTH_LONG);
				...
				finish();}
					...
					Toast.makeText(ShippingInformationActivity.this,e.toString(),Toast.LENGTH_LONG);
