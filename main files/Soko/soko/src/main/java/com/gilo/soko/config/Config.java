...
public class Config {
    ...
    public static final String CONFIG_CLIENT_ID = "ARZXJHWApEOnmZgLtE8moR2UFLDpnMKd3n3bkLL9wBw8Q0C3eUAJMvgyM6FU8Z7d3qez0Y8gyrlQSbxE";
    ...
    public static String STORE_URL = "http://kooler.in";
    
    public static String API_URL = "http://kooler.in/wp-admin/wooApi/api/";
    public static String IMAGE_FULL ="http://kooler.in/wp-admin/wooApi/img/";
