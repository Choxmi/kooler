...
public class CheckOutActivity extends ActionBarActivity{
	...
	protected void onCreate(Bundle icicle) {
		...
		Toast.makeText(CheckOutActivity.this,"Retrieve data Loading",Toast.LENGTH_LONG);
		Log.e("Retrieve","Retrieve data from place");
		...
		.retrieve(new RetrievalCallback<Place>() {
			...
			public void retrievedResults(
				...
				if (entities.size() > 0) {
					...
					Toast.makeText(CheckOutActivity.this,"Entities Loading",Toast.LENGTH_LONG);
					Log.e("Entity", "Loading...");
					tvShipping.setText(shipping);
					ivEditShipping.setImageResource(R.drawable.pencil);
					
				}
				else{
					Toast.makeText(CheckOutActivity.this,"Entities num zero",Toast.LENGTH_LONG);
					Log.e("Entity", "zero");
				}
			}
		});
